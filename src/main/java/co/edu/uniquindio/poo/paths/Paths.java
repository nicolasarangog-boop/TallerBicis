package co.edu.uniquindio.poo.paths;


public class Paths {

    //Ruta base de los archivos fxml
    public static final String BASE = "/co/edu/uniquindio/poo/files/";

    //Rutas de los archivos fxml
    public static final String INICIO = BASE + "inicio.fxml";
    public static final String REGISTRO_CLIENTE = BASE + "registroCliente.fxml";
    public static final String REGISTRO_MECANICO = BASE + "registroMecanico.fxml";
    public static final String REGISTRO_BICICLETA = BASE + "registroBicicleta.fxml";
    ...
    public static final String CSS_REGISTRO_CLIENTE= BASE + "css/cliente.css";
    public static final String CSS_REGISTRO_MECANICO= BASE + "css/mecanico.css";
    public static final String CSS_REGISTRO_BICICLETA= BASE + "css/bicicleta.css";
